...
class HeaderPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(size.width * 0.30, size.height * 0.23, size.width * 0.54, size.height * 0.18,size.width * 0.68, size.height * 0.16);
...
class FooterPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint.color = Color(0xFFAFAB40).withOpacity(1);
    path = Path();
